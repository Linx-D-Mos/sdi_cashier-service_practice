...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('collected_bags', function (Blueprint $table) {
            ...
            $table->string('bag_id')->index()->comment('Identificador de la bolsa (puede ser código de barras, QR, etc.)');
            $table->string('lock_id')->comment('Identificador del candado asociado a la bolsa');
            $table->unsignedInteger('packages_amount')->nullable()->comment('Cantidad real de paquetes encontrados en la bolsa durante la recolección');
